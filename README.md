...
Gunakan branch berdasarkan pekerjaan atau perubahan yang dilakukan.
...
- Pastikan kode sudah dilakukan testing
- Pastikan tidak terdapat conflict
- Gunakan judul Merge Request sesuai ID OpenProject
...
OP-13127 | Update template Blade berdasarkan mockup UI


Description:

Perubahan:
- Update struktur halaman Blade
- Menyesuaikan tampilan dengan desain UI
- Memperbaiki responsive layout

Testing:
- Halaman berhasil dijalankan
- Tampilan responsive berjalan dengan baik
```
