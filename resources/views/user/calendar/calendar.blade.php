            ...
            <aside class="lg:col-span-4">
                <div class="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm lg:sticky lg:top-24">
                    ...
                    <div class="mb-4 border-b border-slate-100 pb-4">
                        <span class="text-xs font-bold uppercase tracking-wide text-blue-600">Agenda Terpilih</span>
                        <h2 id="selectedDateTitle" class="text-shadow mt-1 text-xl font-extrabold text-slate-900 md:text-2xl">
