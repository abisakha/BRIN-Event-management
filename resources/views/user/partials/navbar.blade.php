    ...
    <div class="grid min-h-10 grid-cols-12 items-center gap-3">
        ...
        <div class="{{ auth()->check() ? 'col-span-3 sm:col-span-4 lg:col-span-2' : 'col-span-3 sm:col-span-4 lg:col-span-1' }} flex items-center justify-end">
            ...
            <div class="flex items-center gap-2">
                ...
                <!-- NOTIFICATION -->
                <a href="{{ url('/notifications') }}" class="relative flex size-9 items-center justify-center rounded-full bg-slate-50 text-slate-600 no-underline! transition duration-300 hover:bg-blue-600 hover:text-white! hover:shadow-md">
                ...
                <!-- PROFILE -->
                <a href="#" class="flex h-9 items-center gap-2 rounded-full bg-slate-100 px-2 pr-3 no-underline! transition duration-300 hover:bg-slate-200 hover:shadow-sm">
