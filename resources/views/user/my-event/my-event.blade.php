        ...
        <div class="mb-6 rounded-2xl border border-slate-200 bg-white px-5 pt-4 shadow-sm">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <form action="{{ url('/my-event') }}" method="GET" class="mb-3 flex w-full items-center gap-2 sm:w-auto">
                    ...
                    <select name="sort"
                            class="h-10 flex-1 cursor-pointer rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm font-medium text-slate-700 outline-none transition hover:border-blue-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-100 sm:flex-none">
                    ...
                    <button type="submit"
                            class="h-10 rounded-xl! bg-blue-600 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 hover:shadow-md active:scale-95">
                        Apply
                    </button>
